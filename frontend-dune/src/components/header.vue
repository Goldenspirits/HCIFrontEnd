<template>
  <div>
    <div class="header">
      <div class="mytitle">
        <img class="myLogo" src="../assets/Autopia.png">
      </div>
      ...
      <a-menu
          ...
          class="menu-top">
          <a-menu-item class="menu-top-item" key="/search" >
            <a-icon type="desktop"/>
            <span>主页</span>
          </a-menu-item>
      ...
      <a-dropdown class="userinfo" placement="bottomCenter">
        <div id="user">{{this.userInfo.username}}</div>
...
<script>
  ...
  export default {
    ...
    async mounted(){
      if(this.userId === -1) {this.getUserInfo()}
    },
    methods: {
      ...mapActions([
        'logout',
